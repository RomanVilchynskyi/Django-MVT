...
SECRET_KEY = 'django-insecure-!*_byif+)lj2%l9(lk*li5evj-8fx3b09tq#^fu@)%t=vgf_gz'
...
ROOT_URLCONF = 'rentcars_proj.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'favorites.context_processor.favorite_cars_count'
            ],
        },
    },
]

WSGI_APPLICATION = 'rentcars_proj.wsgi.application'
